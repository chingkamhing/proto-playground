...
// user session is obtained from user session (i.e. Bearer key)
type UserSession struct {
	...
	Accounts string `protobuf:"bytes,2,opt,name=accounts,proto3" json:"accounts,omitempty" db:"Accounts"`
	// @inject_tag: db:"GameID"
	GameID int32 `protobuf:"varint,3,opt,name=gameID,proto3" json:"gameID,omitempty" db:"GameID"`
	// @inject_tag: db:"Nullity"
	Nullity bool `protobuf:"varint,4,opt,name=nullity,proto3" json:"nullity,omitempty" db:"Nullity"`
}
...
func (x *UserSession) GetUserID() int32 {
	if x != nil {
		return x.UserID
	}
	return 0
...
func (x *UserSession) GetAccounts() string {
	if x != nil {
		return x.Accounts
	}
	return ""
...
func (x *UserSession) GetGameID() int32 {
	if x != nil {
		return x.GameID
	}
	return 0
...
func (x *UserSession) GetNullity() bool {
	if x != nil {
		return x.Nullity
	}
	return false
...
var file_gateway_gateway_struct_proto_rawDesc = []byte{
	...
	,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x5f, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_gateway_gateway_struct_proto_goTypes = []interface{}{
	(*UserSession)(nil), // 0: gateway.UserSession
}
